...
""")
        ...
        self.actionqwenasrlocal_key = QtGui.QAction(MainWindow)
        self.actionqwenasrlocal_key.setObjectName("actionqwenasrlocal_key")
        ...
        self.menu_RECOGN.addSeparator()
        self.menu_RECOGN.addAction(self.actionqwenasrlocal_key)
        self.menu_RECOGN.addSeparator()
